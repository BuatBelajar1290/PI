      ...
      <nav class="navbar navbar-expand-lg  navbar-light py-lg-0 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav ms-auto p-4 p-lg-0">
            <li><a href="#/admin-home" class="nav-item nav-link">Beranda</a></li>
            <li><a href="#/admin-data-puskesmas" class="nav-item nav-link">Puskesmas</a></li>
            <li><a href="#/admin-home"  class="nav-item nav-link">Kontak</a></li>
            <li><a href="#/beranda" class="nav-item nav-link">Logout</a></li>
          </ul>
